...
// Setting for Copyright text.
$wp_customize->add_setting( 'third_section_text',
    array(
        'default'           => __( 'All About Our 
        Homeowner’s Organization', 'third_section_text' ),
        'sanitize_callback' => 'sanitize_text_field',
        'transport'         => 'refresh',
    )
);
$wp_customize->add_control( 'third_section_text', 
    array(
        'type'        => 'text',
        'priority'    => 20,
...
// Setting for Copyright text.
$wp_customize->add_setting( 'third_section_textarea',
    array(
...
$wp_customize->add_control( 'third_section_textarea', 
    array(
        'type'        => 'textarea',
        'priority'    => 30,
        'section'     => 'third_text_options',
...
// Setting for Images.
$wp_customize->add_setting( 'third_section_image',
    array(
...
$wp_customize->add_control( new WP_Customize_Image_Control($wp_customize, 'third_section_image', 
    array(
        'priority'    => 40,
        'section'     => 'third_text_options',
        'label'       => 'Image',
