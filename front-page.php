       ...
       <div class="container thirdSection_container">
           <div class="rows thirdSection_rows">
               <div class="col-12 thirdSection_column text-center">
                <div class="thirdSection_aboutUs">
                    <h1 class="thirdSection_heading">
                        <?php printf( get_theme_mod('third_section_text', __( 'All About Our <br> Homeowner’s Organization', 'third_section_text' ) )); ?>
                    </h1>
                <hr class="thirdSection_spacer">
                <p class="thirdSection_paragraph">
                ...
                <img class="article-image" src="<?php echo get_theme_mod('third_section_image',get_bloginfo('template_directory').'/assets/images/map.png' )?>" border="0" alt="map">
                </div>
            </div>
       </div>
   </section>
