...
// scripts
function scripts() {
	wp_enqueue_script( 'bootstrap1', 'https://cdn.jsdelivr.net/npm/bootstrap@5.2.0/dist/js/bootstrap.bundle.min.js', array(), '5.2.0', true );
	wp_enqueue_script( 'bootstrap2', 'https://cdn.jsdelivr.net/npm/@popperjs/core@2.11.5/dist/umd/popper.min.js', array(), '2.11.5', true );
	wp_enqueue_script( 'bootstrap3', 'https://cdn.jsdelivr.net/npm/bootstrap@5.2.0/dist/js/bootstrap.min.js', array(), '5.2.0', true );
	wp_enqueue_script( 'template_script', get_template_directory_uri() . '/inc/js/header.js', array(), '5.2.0', true );
}
